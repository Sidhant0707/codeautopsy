      ...
      CodeAutopsy
          ...
          <div className="max-w-xl">
            ...
            <p className="text-xl text-slate-400 leading-relaxed mb-12">
              AI-powered intelligence that transforms sprawling repositories into clear, actionable insights in seconds.
            </p>

            <div className="flex flex-col gap-6">
              {[
                { icon: Zap, text: "Instant architecture mapping" },
                { icon: GitBranch, text: "Dependency relationship visualization" },
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-24">
        ...
        <div className="w-full max-w-[440px]">
          <div className="mb-10 text-center md:text-left">
            <h2 className="cabinet text-3xl font-bold mb-2 tracking-tight">Welcome back</h2>
            <p className="text-slate-400">Sign in to continue your codebase autopsy.</p>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest">
              <span className="bg-[#0e0e0e] px-4 text-slate-500 font-bold">Or email</span>
            </div>
          </div>
          ...
          <div className="mt-16 flex justify-center gap-6">
            {["Terms", "Privacy", "Support"].map((item) => (
              <a key={item} href="#" className="text-[11px] text-slate-600 hover:text-slate-400 uppercase tracking-widest transition-colors">
                {item}
              </a>
            ))}
          </div>
