...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-[#0e0e0e]">
      ...
      <section
        id="features"
        className="py-24 sm:py-32 px-4 sm:px-6 relative z-10"
      >
      ...
      <section
        id="about"
        className="py-24 sm:py-32 px-4 sm:px-6 bg-black/40 relative z-10 border-y border-white/[0.05]"
      >
        <div className="max-w-7xl mx-auto">
          <SectionHeader
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <div className="mb-6 sm:mb-8 relative z-10 pr-4">
                ...
                <p className="min-h-12 text-sm leading-6 text-slate-400">
                  For learning, scouting, and lightweight repo analysis.
                </p>
              </div>
            ...
            >
              ...
              <div className="mb-6 sm:mb-8 relative z-10 pr-4">
                <h3 className="text-xl font-bold mb-2 text-slate-500 italic">
                  Specialist
                </h3>
                <p className="min-h-12 text-sm leading-6 text-slate-400">
                  For engineers using CodeAutopsy in daily work.
                </p>
              </div>
            ...
            >
              ...
              <div className="mb-6 sm:mb-8 relative z-10 pr-4">
                ...
                <p className="min-h-12 text-sm leading-6 text-slate-400">
                  For teams with deeper security and workflow needs.
                </p>
              </div>
