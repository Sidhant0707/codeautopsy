    ...
    <div className="min-h-screen relative overflow-x-hidden bg-gradient-to-b from-[#0e0e0e] via-[#0e0e0e] to-[#1a1a1a] flex items-center justify-center py-24 px-6">
      ...
      >
        <motion.div variants={fadeUp} className="mb-12">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/[0.03] border border-white/10 text-slate-400 text-xs font-bold uppercase tracking-widest hover:bg-white/[0.08] hover:text-white transition-all hover:border-white/20"
          >
            ← Back to Home
          </Link>
        </motion.div>
        ...
        <motion.p
          variants={fadeUp}
          className="text-lg md:text-xl text-slate-400 mb-14 max-w-lg mx-auto leading-relaxed"
        >
          Have a question about the AI analysis, need custom enterprise limits,
        ...
        >
          ...
          <a
            ...
            className="glass-card p-8 rounded-2xl border border-white/5 hover:bg-white/[0.02] hover:border-white/20 transition-all duration-300 group flex flex-col items-center text-center"
          >
            ...
            <span className="font-bold text-lg text-slate-200 group-hover:text-white transition-colors duration-300">
              Twitter (X)
            </span>
