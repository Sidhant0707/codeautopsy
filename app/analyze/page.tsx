                ...
                <div className="max-w-xl w-full glass-card p-8 rounded-2xl border border-white/10 bg-[#0e0e0e]/80 text-center shadow-2xl transition-all">
                  {!prResult ? (
                    <>
                      ...
                      <div
                        className={`flex items-center gap-3 bg-black/50 border rounded-xl p-2 transition-colors ${prError ? "border-red-500/50" : "border-white/10 focus-within:border-white/30"}`}
                      >
                        ...
                        <input
                          ...
                          className="flex-1 bg-transparent border-none outline-none text-slate-200 placeholder:text-slate-600 font-mono text-sm px-2 disabled:opacity-50"
                        />
                        <button
                          onClick={handleAnalyzePR}
                          disabled={isAnalyzingPR || !prInput.trim()}
                          className="px-6 py-2 bg-white/10 hover:bg-white/20 disabled:bg-white/5 disabled:text-slate-500 text-white font-bold text-sm rounded-lg transition-colors flex items-center gap-2"
                        >
                          {isAnalyzingPR ? (
                            <>
                    ...
                    <div className="w-full text-left animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <div className="flex items-start justify-between mb-6 pb-6 border-b border-white/10">
                        ...
                        <div
                          className={`flex-shrink-0 px-3 py-1.5 rounded-lg border text-xs font-bold uppercase tracking-widest flex items-center gap-2 ${
                      ...
                      <div className="flex justify-center border-t border-white/10 pt-6">
                        <button
                          ...
                          className="px-6 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-sm font-bold text-slate-300 transition-all flex items-center gap-2"
                        >
