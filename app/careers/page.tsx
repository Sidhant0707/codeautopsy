...
import { FaBrain, FaTerminal, FaUsers } from "react-icons/fa";
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-lg max-w-2xl leading-relaxed">
            We are building tools that help developers understand code at the
            speed of thought. No more manual browsing. No more onboarding
            friction.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            {
              icon: FaTerminal,
              title: "Pure Dev Focus",
              text: "Zero meetings. 100% focused on shipping code that matters.",
            },
            {
              icon: FaBrain,
              title: "AI-First Culture",
              text: "Experiment with the latest LLM architectures every single day.",
            },
            {
              icon: FaUsers,
              title: "Remote Native",
              text: "Work from anywhere in the world. We value output over hours.",
            },
          ].map((perk, i) => (
            <motion.div
              key={i}
        ...
        <div className="space-y-12">
          <motion.div
            variants={fadeUp}
            className="text-center py-12 border-y border-white/5"
          >
            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">
              Currently in Stealth
            </h2>
            <p className="text-slate-500 max-w-xl mx-auto text-sm leading-relaxed">
              CodeAutopsy is currently in a high-growth development phase. We
              are focusing on core architecture and user-market fit before
          ...
          >
            ...
            <p className="text-slate-500 text-sm mb-8 max-w-md mx-auto">
              We don&rsquo;t hire often, but when we do, we look at our internal
              talent pool first. Send your GitHub/Portfolio to be notified when
              the doors open.
            </p>
            <Link
              href="/contact"
        ...
        >
          ...
          <p className="text-slate-500 text-sm mb-8">
            We&rsquo;re always looking for talented hackers. Send your GitHub
            and a brief intro to sidhantkumar0707@gmail.com
          </p>
          <Link
            href="/contact"
            className="text-white text-xs font-bold uppercase tracking-[0.2em] border-b border-white/20 pb-1 hover:border-white transition-all"
          >
            General Application →
          </Link>
        </motion.div>
