      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <p className="text-slate-600 text-sm italic">
            &ldquo;We build for developers. We respect your code as if it were
            our own.&rdquo;
          </p>
          <div className="mt-8">
            <Link
              href="/contact"
              className="text-white text-xs font-bold uppercase tracking-widest hover:underline decoration-slate-500 underline-offset-4"
            >
